...
## MycoSNP-WDL
WDL wrappers of [CDCGov/mycosnp-nf for](https://github.com/CDCgov/mycosnp-nf) for Terra.bio for *Candiozyma auris* variant calling and single nucleotide polymorphism (SNP) phylogenetic tree reconstruction.
...
|---|---|---|---|---|---|
| mycosnptree_nf | **vcf** | Array[File] | VCF files for analysis |  | Required |
| mycosnptree_nf | **vcf_index** | Array[File] | Index files for the VCF files |  | Required |
...
| mycosnp_version | String | Version of MycoSNP used |
...
| **Terra Task Name** | **Variable** | **Type** | **Description** | **Default Value** | **Terra Status** |
|---|---|---|---|---|---|
| mycosnpvariants_nf | **reads** | Array[File] | Input reads for variant calling |  | Required |
| mycosnpvariants_nf | **reference** | File | Reference genome file |  | Required |
